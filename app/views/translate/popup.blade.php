                    ...
                    <div class="col-xs-12 col-md-12">
                        <div class="radio">
                            <div class="input-group">
                                <div class="checkbox">
                                    <a class="list-group-item"> <label> <input type="radio" name="optionsRadios" id="optionsRadios0" value="option0" checked>
                                            <h4 class="list-group-item-heading">Original translation</h4>
                                            <p id="originalTranslation" class="list-group-item-text">
                                                Ever heard the trolley problem?
                                            </p>
                                        </label>
                                    </a>
                                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-12">
                        <div class="radio">
                            <div class="input-group">
                                <div class="checkbox">
                                    <a href="" class="list-group-item"> <label> <input type="radio" name="optionsRadios" id="optionsRadios2" value="option2">
